...
public class FragmentLevel30 extends Fragment implements View.OnClickListener{
    private TextView tvLevel;
    private TextView tvStrikes;
    private TextView buttonTrue;
    private TextView buttonFalse;

    Vibrator vibe1;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View mRootView = inflater.inflate(R.layout.fragment_level30, container, false);
        buttonTrue = (TextView)mRootView.findViewById(R.id.buttonTrue);
        buttonFalse = (TextView)mRootView.findViewById(R.id.buttonFalse);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.buttonTrue:
                ...
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container_fragment,new FragmentLevel31()).commit();
                break;
