...
public class FragmentLevel25 extends Fragment implements View.OnClickListener{
    private TextView tvLevel;
    private TextView tvStrikes;
    private ImageView buttonTrue;
    private ImageView buttonFalse2;
    private ImageView buttonFalse3;
    private ImageView buttonFalse4;
    private ImageView buttonFalse5;
    Vibrator vibe1;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View mRootView = inflater.inflate(R.layout.fragment_level25, container, false);
        buttonTrue = (ImageView)mRootView.findViewById(R.id.buttonTrue);
        buttonFalse2 = (ImageView)mRootView.findViewById(R.id.buttonFalse2);
        buttonFalse3 = (ImageView)mRootView.findViewById(R.id.buttonFalse3);
        buttonFalse4 = (ImageView)mRootView.findViewById(R.id.buttonFalse4);
        buttonFalse5 = (ImageView)mRootView.findViewById(R.id.buttonFalse5);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.buttonTrue:
                ...
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container_fragment,new FragmentLevel26()).commit();
                break;
