...
public class FragmentLevel31 extends Fragment implements View.OnClickListener{
    private TextView tvLevel;
    private TextView tvStrikes;
    private ImageView buttonTrue;
    private ImageView buttonFalse;

    Vibrator vibe1;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View mRootView = inflater.inflate(R.layout.fragment_level31, container, false);
        buttonTrue = (ImageView)mRootView.findViewById(R.id.buttonTrue);
        buttonFalse = (ImageView)mRootView.findViewById(R.id.buttonFalse);
