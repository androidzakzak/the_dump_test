...
public class FragmentLevel8 extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View mRootView = inflater.inflate(R.layout.fragment_level8, container, false);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.buttonFalse5:
                ...
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container_fragment,new FragmentLevel9()).commit();
                break;
