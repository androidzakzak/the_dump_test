...
public class FragmentLevel17 extends Fragment implements View.OnClickListener{
    private TextView tvLevel;
    private TextView tvStrikes;
    private RelativeLayout buttonTrue;


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View mRootView = inflater.inflate(R.layout.fragment_level17, container, false);
        buttonTrue = (RelativeLayout)mRootView.findViewById(R.id.buttonTrue);
