...
public class FragmentLevel26 extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View mRootView = inflater.inflate(R.layout.fragment_level26, container, false);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.buttonTrue:
                ...
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container_fragment,new FragmentLevel27()).commit();
                break;
